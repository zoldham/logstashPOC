# -*- encoding: utf-8 -*-
# stub: logstash-filter-de_dot 1.0.4 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-filter-de_dot".freeze
  s.version = "1.0.4"
  ...
  s.summary = "Computationally expensive filter that removes dots from a field name".freeze
